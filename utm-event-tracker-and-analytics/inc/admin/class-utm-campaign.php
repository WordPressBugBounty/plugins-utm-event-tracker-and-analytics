...
final class UTM_Campaign {
	...
	public function admin_menu() {
		add_submenu_page(
			'utm-event-tracker',
			__('UTM Campaigns', 'utm-event-tracker-and-analytics'),
			__('Campaigns', 'utm-event-tracker-and-analytics'),
			'manage_categories',
	...
	public function dashboard_widget($widgets) {
		$widgets['utm_campaign'] = array(
			'title' => __('UTM Campaign', 'utm-event-tracker-and-analytics'),
			'aside' => 'left',
			'priority' => 10,
			'placement' => 'left',
	...
	public function widget() {
		echo '<overview-widget param="utm_campaign" v-if="!widget_is_visible(\'utm_campaign\')">';
		echo '<template v-slot:header_left>';
		echo '<h3>' . esc_html__('UTM Campaigns', 'utm-event-tracker-and-analytics') . '</h3>';
		echo '</template>';
